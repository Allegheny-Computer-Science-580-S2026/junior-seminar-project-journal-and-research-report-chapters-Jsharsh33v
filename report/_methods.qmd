...
![MaintAlign system architecture showing the data flow from user inputs through optimization and validation to final output.](images/dynamic.png){#fig-runtime width=80%}
