...
![MaintAlign runtime sequence: equipment parameters and planning settings flow through Weibull and Kijima preprocessing into the CP-SAT solver, then either return an optimized schedule or report infeasibility, with successful schedules passing through Monte Carlo validation before the final cost comparison is rendered.](images/dynamic.png){#fig-runtime width=80%}
